      ...
      const response = await fetch(
        "http://localhost/em_management/api/v1/projects/",
        {
          ...
          body: JSON.stringify({
            ...
            project_management_tool: data.project_management_tool,
            project_management_tool_url: data.project_management_tool_url,
            project_repo_tool: data.project_repo_tool,
            project_repo_url: data.project_repo_url,
